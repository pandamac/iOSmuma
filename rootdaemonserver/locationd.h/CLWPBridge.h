...
@class NSMutableDictionary, NSRecursiveLock, WPDeviceScanner, WPZoneTracker, WirelessProximity;
...
- (BOOL)startTrackingZone:(id)arg1 forStates:(int)arg2 transitionHandler:(CDUnknownBlockType)arg3;
...
- (void)stopScan;
- (void)startScanForBeaconTypes:(int)arg1 updateHandler:(CDUnknownBlockType)arg2;
