...
- (id)initWithFireDate:(double)arg1 timeInterval:(double)arg2 serviceIdentifier:(const char *)arg3 wakeDevice:(BOOL)arg4 clTimer:(struct CLPersistentTimer *)arg5 silo:(id)arg6 minimumEarlyFireProportion:(double)arg7;
